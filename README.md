...
- post-AD-016X governance hygiene act встановлює AD-016 `0.25.1` та AD-018/019/020 `0.2.1` як PATCH-only corrections: виправляє exact OCP-011 `0.3.0` evidence cells, реальний `architecture/baselines/foundation-map.md` WJ path і три вичерпані `Review-After` triggers без нового semantic/lifecycle authority;
