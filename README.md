...
- machine-derived current accounting: 23 primary OCP documents (10 Canonical / 8 Accepted / 5 Draft); 8 defined Concepts (6 Canonical / 2 Accepted); 9 governed reviewed snapshots (8 current Accepted + 1 retained historical); 9 P-001 primary invokers; 274 non-sensitive fixtures; 299 unit tests.
