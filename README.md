...
- AD-043 `0.1.0 / Accepted` та OCP-024 `0.1.0 / Draft` задають Route D властивості визнання свідчення повноти — exact subject/scope/time, provenance/authority binding, uniqueness і fail-safe indeterminate — але доказово не називають реального evaluator: synthetic reference coherence не є production authority і нічого не активує;
...
- machine-derived current accounting: 25 primary OCP documents (10 Canonical / 12 Accepted / 3 Draft); 8 defined Concepts (6 Canonical / 2 Accepted); 13 governed reviewed snapshots (12 current Accepted + 1 retained historical); 9 P-001 primary invokers; 302 non-sensitive fixtures; 386 unit tests.
