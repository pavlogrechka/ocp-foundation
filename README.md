...
- AD-016 `0.1.0 / Discovery` відкриває AB-062 для canonicalization-readiness: promotion unit, dependency/Pattern floors, open-question blockers і semantic-vs-production evidence порівнюються без зміни status або `1.0.0`;
