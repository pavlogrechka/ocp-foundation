...
- окремий P-001 evidence-accounting act time-anchor-ить §§11/13 на T3 acceptance baseline і прибирає recurring live invoker count без зміни `0.1.0`, §§1–10/§12 obligations, шести primary invokers, трьох snapshots або checker policy; це закриває Pattern-ledger prerequisite, але не авторизує OCP-004/OCP-017 remediation;
