...
- AD-016Q `0.18.0 / Accepted` виконує повний read-only exact-head audit усіх current Organization lifecycle projections: сім projection-bearing файлів плюс AB-062 accounting утворюють чесний candidate U8; outcome не обрано, O0 лишається чинним, а lifecycle/topology proposal не авторизовано;
