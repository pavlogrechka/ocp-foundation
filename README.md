...
- AD-027 окремо обирає AN, ON і WN; OCP-006 `0.3.0 / Draft` робить виконуваними permutation-invariant absence of normative application order, no-override і no-contextual-waiver boundaries без Policy/Authority/Approval/Exception/Waiver Concept або позитивного operational result;
...
- reference suite містить 239 non-sensitive fixtures і 231 unit tests;
