...
- machine-derived current accounting: 23 primary OCP documents (10 Canonical / 8 Accepted / 5 Draft); 8 defined Concepts (6 Canonical / 2 Accepted); 9 governed reviewed snapshots (8 current Accepted + 1 retained historical); 9 P-001 primary invokers; 274 non-sensitive fixtures; 315 unit tests.
- не-нормативна оцінка загальної foundation-готовності — **≈72%**; Canonical Concepts — Capability, Objective, Resource, Organization, Operation та Event, Accepted Concepts — Assignment і Constraint; OCP-017, OCP-018 і OCP-020 є Accepted Route C contracts, OCP-019, OCP-021 та OCP-022 лишаються Draft negative boundaries, OCP-006 додає application-order, override та waiver owner-local negative boundaries, а positive Conflict/capacity/reservation/Order/precedence/override/waiver activation, production profiles та T7–T10 потребують власних рішень і свіжих Board gates.
