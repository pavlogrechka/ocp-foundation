...
- AD-016R `0.19.0 / Accepted` обирає O7V лише як підготовку окремого OCP-005 `0.2.4` preflight PATCH для stale Organization status view; O0 лишається lifecycle-рішенням, а repair merge і post-repair comparison потребують власних exact-head gates;
