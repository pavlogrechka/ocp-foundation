...
- AD-044 `0.1.0 / Discovery` перебирає всі три Assignment whole-freeze blockers і всі 10 resolution classes проти live OCP-023 completeness need: Q2 лишається `undecidable-from-inside`, а Q3/Q9 і Q5 мають pressure через відсутні observation-cut та part–whole closure bindings; жодна точна розв'язка не обирається й блокери не рухаються;
...
- machine-derived current accounting: 25 primary OCP documents (10 Canonical / 12 Accepted / 3 Draft); 8 defined Concepts (6 Canonical / 2 Accepted); 13 governed reviewed snapshots (12 current Accepted + 1 retained historical); 9 P-001 primary invokers; 296 non-sensitive fixtures; 370 unit tests.
