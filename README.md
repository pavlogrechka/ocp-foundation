...
- OCP-001 `0.9.0` визначає mandatory Core Boundary trigger, а OCP-016 `1.0.0 / Canonical` стабілізує Routes F/C/E/D/I без self-approval, admission registry, numeric score, P-002 або machine authority; AB-061 Resolved;
...
- не-нормативна оцінка загальної foundation-готовності після T1 — **≈64%**.
