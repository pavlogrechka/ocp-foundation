...
- не-нормативна оцінка загальної foundation-готовності після завершення T0–T3 enabling phase — **≈67%**; AD-016C reassessment і окремий AD-016D Board act лишаються обов'язковими перед T4.
