...
- AD-017 `0.1.0 / Discovery` відкриває AB-063 і outcome-fair порівнює strict immutability, identified amendment, exact versioned snapshot та display-only exclusion; він не змінює OCP-008, Objective status, P-001 invocation, consumer references або promotion authority;
