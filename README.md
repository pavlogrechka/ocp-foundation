...
- AD-025 outcome-fair обирає QC; OCP-020 `0.1.0 / Draft` визначає Route C non-Concept quantitative input з exact profile/unit/snapshot bindings та exact-unit сумою без capacity-sufficiency, availability, reservation або allocation authority; AB-037 закрито як bounded input/aggregation direction, а AB-025 і всі positive-model gates лишаються Open;
