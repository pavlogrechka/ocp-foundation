...
- четвертий T4 act встановлює OCP-007/Organization `1.0.0 / Canonical`, атомарно оновлює OCP-000/OCP-002 до `1.4.0`, OCP-005 до `0.2.5` та current map/checker-guide/accounting; §§1–32 OCP-007, records, consumers, checker semantics, fixtures, Open Organization questions і T5 authority не змінюються;
...
- не-нормативна оцінка загальної foundation-готовності після завершення T4 — **≈71%**; чотири Concepts Canonical, чотири лишаються Accepted, а перехід до T5 потребує нового topology/scope audit і окремого Board act.
