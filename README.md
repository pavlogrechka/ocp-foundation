...
- AD-045 `0.1.0 / Discovery` перебирає всі шість AD-044 survivors лише проти чинних Accepted/Canonical тверджень: жоден клас не `incompatible`, `WHOLE_RESOURCE_ONLY` є `compatible`, решта п'ять `underdetermined`; питання, blockers і lifecycle authority не рухаються;
