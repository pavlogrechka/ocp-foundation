...
- reference suite містить 205 non-sensitive fixtures і 224 unit tests;
- не-нормативна оцінка загальної foundation-готовності — **≈72%**; п'ять Concepts Canonical, три лишаються Accepted, OCP-017, OCP-018 і OCP-020 є Accepted Route C contracts, OCP-019 та OCP-021 лишаються Draft negative boundaries, а positive Conflict/capacity/reservation activation, production profiles та T6–T10 потребують власних рішень і свіжих Board gates.
