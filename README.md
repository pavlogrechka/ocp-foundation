...
- AD-016P `0.17.0 / Accepted` незалежно закриває всі шістнадцять commissioned targets і обирає O7C лише для підготовки exact seven-file OCP-007/Organization lifecycle proposal; selection act не змінює жоден OCP/Concept lifecycle або backlog status, O0 лишається fail-safe, а сам proposal потребує свіжих exact-head review/adjudication/CI/Board gates;
