...
- AD-016U `0.22.0 / Accepted` заново обчислює post-O9C T5–T10 frontier: OCP-004 має unresolved lifecycle/composition B-items, тоді як bounded OCP-012 surface не має demonstrated B-item; P12 є лише рекомендацією до окремого AD-016V Board selection, а жоден T5 proposal не авторизовано;
