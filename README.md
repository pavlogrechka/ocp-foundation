...
- не-нормативна оцінка загальної foundation-готовності — **≈72%**; п'ять Concepts Canonical, три лишаються Accepted, OCP-017, OCP-018 і OCP-020 є Accepted Route C contracts, OCP-019 лишається Draft boundary, а positive Conflict/capacity activation, production profiles, reservation/allocation та T6–T10 потребують власних рішень і свіжих Board gates.
