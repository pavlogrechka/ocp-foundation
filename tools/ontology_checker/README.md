...
The synthetic fixture covers a complete `Draft → Planned → Authorized → Active → Completed` path and a still-effective Assignment that remains independently effective. Unit attacks cover ambiguous/missing/failing evidence, invalid branching/time/projections, hidden IO2 record identity, unresolved relations, composition cycles, missing F1/V1 provenance and forbidden authorization/Event/outcome/Readiness coupling.
