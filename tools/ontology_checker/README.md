...
- Assignment survivor norm-compatibility discovery with all 25 current primary bodies, a 64-hit six-axis vocabulary sweep with explicit source/rejection dispositions, six pressure survivors, one compatible and five underdetermined results, plus causal exact-Resource/non-inheritance counterexamples;
