...
class AssignmentConsumerCompatibilityTests(unittest.TestCase):
    ...
    def test_all_seven_accepted_consumers_and_each_consumed_token_are_live(self) -> None:
    ...
    def test_probe_mutations_cannot_silently_change_a_consumer_result(self) -> None:
        mutations = {
            "OCP-006": ("SNAP-ASSIGNMENT-001", "MUTATED-SNAPSHOT"),
    ...
    def test_removed_blocker_and_seven_consumer_projection_are_enforced(self) -> None:
            ...
            with self.subTest(mutation=mutation), tempfile.TemporaryDirectory() as tmp:
                ...
                if mutation == "restore-blocker":
                    surface["blockers"].append({
                        ...
                        "consumer_ids": ["OCP-006", "OCP-013", "OCP-015", "OCP-017", "OCP-020", "OCP-021", "OCP-023"],
                    })
