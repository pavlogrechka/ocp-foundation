...
| U10D — Event dependency/stable-surface discovery | Event identity is independent of Operation; stale assessment prose and envelope authority are concrete seams | OCP-004's own relation statement remains unresolved and dependency removal is not demonstrated | not selected now; remains separately reopenable after new evidence or Operation classification |
...
No numeric score, document order, dependency count or prior recommendation decides this table. U10D is rejected neither as invalid nor because Event is less important; it loses this single preparation choice because the unresolved OCP-004 statement is upstream evidence for the exact dependency question U10D would study.
