...
Accepted primaries nevertheless use two presentation models. OCP-011 through OCP-015 replace the primary body with an acceptance act and leave no Draft self-assertion there; OCP-017 and OCP-018 retain the reviewed Draft body in the primary and append the acceptance wrapper. OCP-020 deliberately follows the latter model so its reviewed §§1–14 and manifest section anchors remain byte-stable, which leaves five historical Draft self-assertions inside the current primary body. Current frontmatter and §§15–23 govern lifecycle; those preserved assertions remain review evidence, not current status. Normalizing the mixed presentation convention requires a separate hygiene act across OCP-017, OCP-018 and OCP-020 rather than a local rewrite that would break the required body identity.
