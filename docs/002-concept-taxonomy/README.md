...
Concept `Capability` має статус `Proposed` і отримує defining document у [OCP-009 — Capability Concept](../009-capability-concept/README.md) на підставі прийнятого рішення AD-005C.
