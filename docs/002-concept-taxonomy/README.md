...
Чернетка Concept `Constraint` має статус `Proposed` і визначається в [OCP-006 — Constraint Concept](../006-constraint-concept/README.md).
