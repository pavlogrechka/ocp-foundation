...
- [x] AD-045 Assignment survivor norm-compatibility discovery — exhaust all six pressure survivors against current Accepted/Canonical statements; exclude none, classify one `compatible` and five `underdetermined`, without lifecycle authority
