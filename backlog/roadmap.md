...
7. After this bounded frontier discovery, run a separately mandated fresh reassessment and separate Board selection before any T6/T7 promotion; define `Review-After` through its separately mandated normative governance act before any YR repair.
