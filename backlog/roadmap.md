...
8. After this bounded frontier discovery and completed fresh reassessment, require a separate candidate-specific Board selection before any T6/T7 promotion; define `Review-After` through its separately mandated normative governance act before any YR repair.
