...
| AB-060 | Capability Claim support usability activation | Discovery | AD-013 порівнює OCP-012 F0/A0 control, unified `holder-capability@2`, split declaration/evidence claim kinds і downstream-only activation; окремо шукає legitimate support evaluation-time owner без `recorded_at`/effectivity fallback |
