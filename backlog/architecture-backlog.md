...
| AB-062 | Foundation canonicalization readiness | Planned | T0–T3 enabling phase завершено; AD-016C recompute рекомендує G2 micro-waves inside C з OCP-009 як першим T4 кандидатом, але окремий AD-016D Board act і кожна candidate-local authorization ще обов'язкові |
