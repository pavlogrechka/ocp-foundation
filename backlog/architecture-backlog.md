...
| AB-062 | Foundation canonicalization readiness | Planned | AD-016B обирає R4/L2; T0–T3 enabling phase завершено з Canonical OCP-000/OCP-016/OCP-001/OCP-002 та Accepted P-001 `0.1.0`; AD-016C reassessment і окремий AD-016D Board act перед T4 залишаються Planned |
