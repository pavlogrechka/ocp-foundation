...
| AB-062 | Foundation canonicalization readiness | Planned | AD-016T обирає O9C лише як підготовку exact nine-file OCP-007/Organization lifecycle proposal з mandatory SemVer/status atomicity та O0 stop-rule; lifecycle proposal має власні exact-head gates, T5 лишається closed, а AB-006/AB-044–AB-047/AB-051/AB-052 лишаються Open |
