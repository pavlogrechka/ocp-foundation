...
| AB-059 | Cross-vertical visibility policy та agreement semantics | Discovery | AD-010 порівнює окремі visibility-policy та agreement-semantics outcomes; confirmation не є permission, consensus, selection чи Assignment authority |
