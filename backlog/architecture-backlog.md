...
| AB-018 | Conflict між Operation як факт або похідний результат | Open | AD-023 на `main@f69e4b31` підтверджує закриті OCP-019 §9 / OCP-016 G4 ворота: жоден Accepted consumer не exact-bind-ить позитивну потребу, rule, snapshot/context, legitimate owner/evaluator і object class; найкоротший шлях — окремий Accepted OCP-004 conflict-use activation/profile, після якого потрібен новий Board act |
