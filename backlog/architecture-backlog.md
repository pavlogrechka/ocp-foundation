...
| AB-062 | Foundation canonicalization readiness | Planned | OCP-003 `0.7.0 / Draft` реалізує AD-018A RS як один stable kernel, explicit exclusions і non-governed working catalog; Resource лишається Accepted, R0 — fail-safe, AB-006/AB-052 відкриті, а наступним gate є fresh post-remediation audit і окремий Board act |
