...
| AB-062 | Foundation canonicalization readiness | Planned | AD-020A `0.2.0 / Accepted` обирає Q3I лише як напрям; окремий P-001 evidence-accounting act усуває recurring live invoker count без version/form/invoker/snapshot зміни й закриває Pattern-ledger prerequisite, але bounded OCP-004 `0.9.0 / Draft` + Route C OCP-017 `0.1.0 / Draft` remediation ще не авторизовано; Q0 і readiness ≈71% незмінні |
