...
| AB-062 | Foundation canonicalization readiness | Discovery | AD-016 `0.1.0` має порівняти promotion unit, dependency/Pattern status floor, open-question blockers і semantic-vs-production readiness без зміни жодного status або `1.0.0` у Discovery |
