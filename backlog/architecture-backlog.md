...
| AB-062 | Foundation canonicalization readiness | Planned | Третій T4 micro-wave встановлює OCP-003/Resource `1.0.0 / Canonical` з exact ten-file atomic projections і трьома PATCH-only consumer views; наступний remaining-T4 scope потребує нового Board act, AB-006/AB-052 лишаються Open |
