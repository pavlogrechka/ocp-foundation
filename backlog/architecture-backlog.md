...
| AB-061 | Core Boundary admission and extension contract | Discovery | AD-015A `0.2.0` порівнює semantic-admission models G0–G4 та artifact homes H0–H5 без вибору; далі — зовнішній review і окремий AD-015B Board act без implementation artifact у тому самому циклі |
