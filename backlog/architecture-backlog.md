...
| AB-059 | Cross-vertical visibility policy та agreement semantics | Discovery | AD-010 має окремі V0–V3 та A0–A3 comparison verdicts і повний map 15 контрприкладів; наступний gate — exact-head external review перед будь-яким outcome selection |
