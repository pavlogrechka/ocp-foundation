...
| AB-062 | Foundation canonicalization readiness | Planned | AD-016U після завершення T4 фіксує OCP-004 B-items і bounded OCP-012 без demonstrated B-item та рекомендує P12 лише до окремого AD-016V Board selection; жоден T5 proposal не авторизовано, а AB-006/AB-044–AB-047/AB-051/AB-052 лишаються Open |
