...
| AB-062 | Foundation canonicalization readiness | Planned | AD-016D обирає G2 micro-waves inside C/L2 і дозволяє підготовку лише окремого OCP-009 T4 draft; candidate merge, інші T4 кандидати та наступний micro-wave мають окремі Board gates |
