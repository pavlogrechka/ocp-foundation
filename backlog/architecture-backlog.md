...
| AB-063 | Objective editorial-correction authority | Planned | AD-017B `0.3.0` обирає A+D: immutable stored statement + display exclusion; наступний окремий акт має реалізувати OCP-008 `0.3.0` з evidence без promotion authority |
