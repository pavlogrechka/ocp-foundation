...
| AB-062 | Foundation canonicalization readiness | Planned | Q1 завершено OCP-003 `0.6.1` + OCP-004 `0.8.1`: виправлено лише два stale Capability status views; далі заново обчислити OCP-008/Objective lifecycle draft на новому `main`, з окремими gates і без зміни OCP-003/OCP-007 blockers |
