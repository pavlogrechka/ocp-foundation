...
| AB-059 | Cross-vertical visibility policy та agreement semantics | Open | Окремо визначити visibility policy і negotiation, consensus або agreement semantics понад OCP-015; confirmation не є permission, selection чи Assignment authority |
