...
| AB-057 | Holder-specific Capability Claim boundary | Discovery | AD-007 / PR-0014: вибрати declaration, assessment, dual-record, derived-only або domain-envelope модель; зафіксувати Resource-only endpoint, exact Capability binding, evidence/time semantics, P-001 modules і fail-safe authority до AB-011 |
