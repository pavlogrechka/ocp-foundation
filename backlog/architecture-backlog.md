...
| AB-062 | Foundation canonicalization readiness | Planned | AD-016U `0.22.0` заново виводить рівно чотири remaining candidates, зберігає strict T5 Operation / T6 Assignment+Event / T7 Constraint, рекомендує лише U4D до окремого AD-016V Board comparison і не авторизує discovery, OCP/Pattern edit або lifecycle act; readiness лишається ≈71% |
