...
| AB-062 | Foundation canonicalization readiness | Planned | T5 WJ joint lifecycle act встановлює OCP-004/Operation `1.0.0 / Canonical` та Route C OCP-017 `0.2.0 / Accepted` лише після окремої готовності обох сторін в одному exact twelve-file unit; AB-015/016/017/018/019/020/023/028 не резолвляться, T6–T10 не відкриваються за implication, а readiness ≈72% |
