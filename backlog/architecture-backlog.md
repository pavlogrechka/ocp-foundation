...
| AB-062 | Foundation canonicalization readiness | Planned | AD-016B обирає R4/L2; T0 OCP-000 і T1 OCP-016 Canonical, а окремі T2–T3 cycles та AD-016C + AD-016D gates перед T4 залишаються Planned |
