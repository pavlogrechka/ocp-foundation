...
| AB-025 | Reservation / Allocation як окремий Concept | Open | AD-025 відокремлює whole-Resource exclusivity від partial/quantitative reservation: перше потребує власного object-form рішення, друге додатково чекає accepted OCP-020 та окремий OCP-016 G4 consumer gate; жоден Concept або record не вибрано |
...
| AB-037 | Quantity, demand and capacity model | Resolved | AD-025 обирає QC і OCP-020 `0.1.0 / Draft`: exact profile/unit/snapshot inputs та exact-unit aggregation без capacity-sufficiency або availability result; acceptance і positive capacity activation потребують окремих актів та Accepted consumer за OCP-016 G4 |
