...
| AB-062 | Foundation canonicalization readiness | Planned | AD-016O `0.16.0 / Accepted` виконує fresh post-Q2 audit: bounded OCP-007 promise не має demonstrated current B-item, O7C seven-file lifecycle proposal є лише рекомендацією, O0 лишається fail-safe; окремий AD-016P Board selection обов'язковий до будь-якого lifecycle draft, а AB-006/AB-044–AB-047/AB-051/AB-052 лишаються Open |
