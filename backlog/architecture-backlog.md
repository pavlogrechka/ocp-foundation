...
| AB-062 | Foundation canonicalization readiness | Planned | четвертий T4 act встановлює OCP-007/Organization `1.0.0 / Canonical`; окремий OCP-007 `1.1.0` correction додає лише документо-локальні SemVer-правила без semantic/migration authority; наступний remaining-T4 reassessment має власні exact-head gates, T5 лишається closed, а AB-006/AB-044–AB-047/AB-051/AB-052 лишаються Open |
