...
| AB-062 | Foundation canonicalization readiness | Planned | AD-018 `0.1.0 / Discovery` порівнює R0/RI/RE/RS/RX: current fixtures carry classification labels but do not prove a closed taxonomy; RS є лише leading hypothesis, R0 — fail-safe, а окремий AD-018A має вибрати semantic treatment до будь-якої OCP-003 remediation |
