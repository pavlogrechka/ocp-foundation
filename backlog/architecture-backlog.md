...
| AB-062 | Foundation canonicalization readiness | Planned | AD-016B обирає R4/L2; T0 встановлює OCP-000 `1.0.0 / Canonical` як registry contract без зміни Concept rows, а окремі T1–T3 cycles і AD-016C + AD-016D gates перед T4 залишаються Planned |
