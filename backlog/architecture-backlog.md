...
| AB-060 | Capability Claim support usability activation | Planned | AD-013B `0.3.0` обирає Outcome B, OCP-012 source use, explicit modes і reviewed `declaration-only → evidence-backed` transition; наступний цикл — окрема OCP-012 activation з F1/A1 rules та 21 counterexamples |
