...
| AB-062 | Foundation canonicalization readiness | Planned | Другий T4 micro-wave встановлює OCP-008/Objective `1.0.0 / Canonical` з atomic projections і bounded OCP-004 `0.8.2`; до будь-якого третього T4 draft потрібен новий Board scope act, а OCP-003/OCP-007 identity blockers лишаються відкритими |
