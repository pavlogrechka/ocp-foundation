...
| AB-062 | Foundation canonicalization readiness | Planned | AD-016B `0.3.0 / Accepted` обирає R4 (`F → C`) і L2, планує окремі T0–T3 enabling cycles та вимагає AD-016C reassessment + окремий AD-016D Board act перед T4; сам selection act не виконує promotion |
