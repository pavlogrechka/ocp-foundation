...
| AB-057 | Holder-specific Capability Claim boundary | Planned | Review OCP-012 `0.1.0 / Draft`: a single narrowly attributable Resource CapabilityClaimRecord with exact OCP-009 binding, P-001 Modules A/C and fail-safe claim-head projection; keep assessment and AB-011 selection separate |
