...
| AB-011 | Взаємозамінність Resource | Planned | AD-008 Discovery: порівняти directional contextual substitution models за exact Capability claims, candidate-specific Constraint results і explicit operational context без втрати Resource identity |
