...
| AB-063 | Objective editorial-correction authority | Discovery | AD-017A `0.2.0` порівнює A–D на 12 consumer scenarios і 16 counterexamples; A+D є leading minimal complete hypothesis, але outcome selection належить окремому AD-017B Board act |
