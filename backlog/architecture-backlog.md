...
| AB-062 | Foundation canonicalization readiness | Planned | OCP-007 `0.4.0 / Draft` Q2 remediation підготовлено окремим review-gated циклом: дві readable surfaces, exact external T2 envelope, dataset-local S1, unconditional E1 та C2/K3/Y1/R1/U0/M0 fail-safe boundaries; remediation не змінює lifecycle/topology і не вирішує AB-006/AB-044–AB-047/AB-051/AB-052; fresh post-remediation audit і Board act обов'язкові |
