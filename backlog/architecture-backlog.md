...
| AB-057 | Holder-specific Capability Claim boundary | Discovery | AD-007 v0.2.0: порівняти declaration, assessment, OCP-011 reuse, dual-record, Resource-local/derived materialization та domain-envelope variants під єдиним AD-005C separate identified-record mandate; зафіксувати Resource-only endpoint, exact Capability binding, evidence/time semantics, P-001 modules і fail-safe authority до AB-011 |
