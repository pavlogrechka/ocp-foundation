...
| AB-062 | Foundation canonicalization readiness | Planned | AD-016K fresh audit не знаходить current semantic B-item у bounded OCP-003 kernel і рекомендує N3 ten-file lifecycle proposal з N0 fail-safe; окремий AD-016L Board selection обов'язковий, AB-006/AB-052 лишаються Open |
