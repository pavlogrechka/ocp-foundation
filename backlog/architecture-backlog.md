...
| AB-062 | Foundation canonicalization readiness | Planned | AD-018A обирає RS лише як підготовку OCP-003 `0.7.0 / Draft` remediation з одним stable kernel, explicit exclusions і non-governed working catalog; R0 лишається fail-safe, AB-006/AB-052 відкриті, а lifecycle scope потребує post-remediation audit і нового Board act |
