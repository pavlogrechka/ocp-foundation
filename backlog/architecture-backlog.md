...
| AB-061 | Core Boundary admission and extension contract | Planned | OCP-001 `0.9.0` + OCP-016 `0.1.0 / Draft` реалізують AD-015B C3 як human-readable trigger/routing split із Routes F/C/E/D/I та orthogonal Pattern form; потрібні external review і окремий acceptance act без admission registry, score або P-002 |
