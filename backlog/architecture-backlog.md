...
| AB-062 | Foundation canonicalization readiness | Planned | Четвертий T4 act встановлює OCP-007/Organization `1.0.0 / Canonical` через exact nine-file O9C unit і завершує T4 без semantic migration; T5 потребує fresh topology/scope audit та окремого Board act, а AB-006/AB-044–AB-047/AB-051/AB-052 лишаються Open |
