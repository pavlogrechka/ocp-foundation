...
| AB-007 | Межа State та Readiness | Discovery | AD-011 окремо порівнює State- і Readiness-моделі за прийнятим evidence contract AD-002; жоден Concept, record type або positive readiness authority ще не обрано |
