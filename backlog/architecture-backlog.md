...
| AB-008 | Межа Infrastructure Resource / Environment | Discovery | AD-014A `0.2.0` порівнює сім consumer scenarios, authority accounting і всі 18 counterexamples; A є current control, B/F — gated positive candidates, Board selection лишається окремим AD-014B act |
