...
| AB-063 | Objective editorial-correction authority | Planned | AD-016E дозволяє лише окремий discovery: порівняти strict immutability, identified amendment, versioned snapshot та display-only exclusion без promotion authority |
