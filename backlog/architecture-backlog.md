...
| AB-062 | Foundation canonicalization readiness | Planned | AD-020 `0.1.0 / Discovery` порівнює H0–H4, lifecycle/authority/dependency та чотири окремі record-form/P-001 осі; Q3 є лише leading hypothesis до AD-020A, а OCP-004, lifecycle, Pattern, graph і readiness ≈71% не змінюються |
