...
| AB-062 | Foundation canonicalization readiness | Planned | AD-016H ставить K8 на паузу й обирає Q1: спочатку окремий OCP-003/OCP-004 PATCH для двох stale Capability status views, потім recomputed OCP-008/Objective lifecycle draft; кожен крок має власні gates, OCP-003/OCP-007 blockers не змінюються |
