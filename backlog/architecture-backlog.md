...
| AB-057 | Holder-specific Capability Claim boundary | Planned | AD-007C selects Outcome B: define a downstream single CapabilityClaimRecord for a narrow attributable Resource claim, preserve an additive future assessment path and expose only a fail-safe claim-head projection to AB-011 |
