...
| AB-058 | Coordination workflows та погодження між незалежними вертикалями | Open | AD-009 `0.2.0 / Under Review` і draft OCP-015 пропонують окремі proposal/response records та fail-safe evidence projection; потрібні external review і explicit Board decision |
