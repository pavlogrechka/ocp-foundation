...
| AB-062 | Foundation canonicalization readiness | Planned | AD-016G обирає K8 та дозволяє підготовку одного окремо reviewed OCP-008/Objective lifecycle draft з atomic projections і bounded OCP-004 cleanup; merge потребує власної авторизації, OCP-003/OCP-007 blockers лишаються |
