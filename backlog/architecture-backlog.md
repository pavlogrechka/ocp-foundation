...
| AB-061 | Core Boundary admission and extension contract | Planned | AD-015B `0.3.0` обирає C3 (`G2 × H2`): один primary semantic-authority route, окремий optional Pattern form route та human-readable OCP-001/OCP-016 ownership split; implementation лишається окремим циклом без admission registry або нового Concept |
