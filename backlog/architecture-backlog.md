...
| AB-062 | Foundation canonicalization readiness | Planned | Перший G2 micro-wave робить OCP-009/Capability `1.0.0 / Canonical`; OCP-003/OCP-007/OCP-008 blockers, інші T4 кандидати та наступний micro-wave потребують нового Board scope act |
| AB-063 | Objective editorial-correction authority | Discovery | AD-017 `0.1.0` порівнює strict immutability, identified amendment, versioned snapshot та display-only exclusion; наступний акт — outcome-fair AD-017A comparison без зміни OCP-008 або promotion authority |
