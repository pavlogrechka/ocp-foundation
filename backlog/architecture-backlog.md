...
| AB-062 | Foundation canonicalization readiness | Planned | AD-016J обирає M3 лише як підготовку окремого AD-018 Resource stable-surface discovery з R0/RI/RE/RS/RX comparison; OCP-003/OCP-007 не редагуються, M0 лишається fail-safe, а semantic outcome та lifecycle scope потребують наступних окремих Board acts |
