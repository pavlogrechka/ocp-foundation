...
| AB-062 | Foundation canonicalization readiness | Planned | AD-016F на exact post-OCP-008A baseline знаходить Objective B-set порожнім, S/C обмеженими та K8 провідною гіпотезою; окремий AD-016G Board act обов'язковий до другого T4 draft, OCP-003/OCP-007 blockers лишаються |
