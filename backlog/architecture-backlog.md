...
| AB-062 | Foundation canonicalization readiness | Planned | T5 WJ joint lifecycle act встановлює OCP-004/Operation `1.0.0 / Canonical` та Route C OCP-017 `0.2.0 / Accepted`; окремий coordination source-metadata PATCH виправляє всі дев'ять OCP-015 manifest owners без executable чи lifecycle change; AB-015/016/017/018/019/020/023/028 не резолвляться, T6–T10 не відкриваються за implication, а readiness ≈72% |
