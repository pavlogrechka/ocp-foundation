...
| AB-062 | Foundation canonicalization readiness | Planned | AD-020A `0.2.0 / Accepted` відхиляє provisional Q3 через unowned IO3/H3–H4 mismatch і обирає Q3I лише як підготовку bounded OCP-004 `0.9.0 / Draft` + Route C OCP-017 `0.1.0 / Draft` remediation; Q0 лишається fail-safe, а lifecycle, Pattern, graph і readiness ≈71% у selection act не змінюються |
