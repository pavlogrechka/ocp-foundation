...
| AB-060 | Capability Claim support usability activation | Discovery | AD-013 `0.2.0` порівнює A–D, B/C lineage sub-options, protected use, evaluation-time owner і всі 21 counterexamples; E/F лишаються gated controls до окремого reopening |
