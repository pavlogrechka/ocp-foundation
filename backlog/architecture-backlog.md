...
| AB-062 | Foundation canonicalization readiness | Planned | Bounded Q3I remediation реалізує OCP-004 `0.9.0 / Draft` + Route C OCP-017 `0.1.0 / Draft` одним atomic tree з F1/V1/LT2, IO2 і незмінним P-001; це не є lifecycle promotion, а fresh post-remediation blocker/stability audit і окремий Board act лишаються обов'язковими; readiness ≈71% |
